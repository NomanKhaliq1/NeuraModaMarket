  ...
  return (
    <main className="min-h-[60vh] bg-gradient-to-br from-white via-[#f5f7fb] to-[#eef6f3] py-16">
      <div className="container mx-auto px-6 space-y-6 text-center">
        ...
        <h1 className="text-3xl md:text-4xl font-semibold text-[#0f172a]">Saved for later</h1>
        <p className="text-gray-600 max-w-3xl mx-auto">Wishlist placeholder. Add items you love and check back anytime.</p>
      </div>
    </main>
  );
}
